...
- `/menu` или `/help` - открыть главное меню с кнопками;
...
Все основные действия также доступны кнопками. У PM и техлида в главном меню
появляется отдельная панель со статусом команды, дедлайнами, дайджестами,
напоминаниями, проверкой интеграций и пошаговым подключением сотрудника.
