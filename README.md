...
запись комментария со ссылкой в chatter. Следующий рубеж - прогнать Telegram E2E,
подключить FSM к PostgreSQL/outbox и заменить demo-рекомендации настоящим AI-вызовом.
